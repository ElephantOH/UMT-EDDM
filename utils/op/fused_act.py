...
print("fused_act_path = {}.".format(module_path))
print("[Warning]: If you see this sentence for a long time and the program does not respond, please clear Conda's cache.")
fused = load(
    "fused",
    sources=[
